...
نصب ابزارهای خارجی برای تبدیل پیشرفته (اختیاری اما پیشنهادشده):

FFmpeg (صدا و ویدیو)

ImageMagick یا Pillow (پردازش تصویر)

Pandoc (تبدیل سند)

LibreOffice (فایل‌های آفیس)

Calibre (کتاب‌های الکترونیک)
